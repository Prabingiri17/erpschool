...
<head>
	...
	<title>SCHOOL ERP| <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
...
<body>
<div class="wrapper">
    <div class="sidebar" data-background-color="teal" data-active-color="success">
    <!--
    ...
    <div class="sidebar-wrapper">
            <div class="logo">
                <a href="./imgdisperse/i.html" class="simple-text">
                    School ERP
                </a>
            </div>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">School Enterprise Resource Planning</a>
                </div>
