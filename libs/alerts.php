...
if ($currentuser=="admin") {
  ...
  <strong><span class="ti ti-announcement fa-2x"></span> </strong> <strong>&nbsp;&nbsp;Welcome Administrator Sir  !!</strong>.
  </div>';
}
elseif ($currentuser=="guest") {
  ...
  redirect("index.php?signIn=1");
    ...
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong><span class="ti ti-announcement fa-2x"></span> </strong> <strong>&nbsp;&nbsp;Welcome Student  !!</strong>.
    </div>';
      }
?>
